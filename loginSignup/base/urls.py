...
from .views import authView, bassins, fournisseurs, home, materiaux, projet_add, projet_delete, projet_edit, projets, volumes

urlpatterns = [
 path("", home, name="home"),

 path('projets/', projets, name='projets'),
 path('projets/add/', projet_add, name='projet_add'),
